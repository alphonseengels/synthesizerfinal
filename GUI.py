...
typeMenu3 = OptionMenu(root, menuText3, "sine", "square", "saw", command=lambda wavetype3: sound.menuThreeHit(wavetype3))
...
typeMenu2 = OptionMenu(root, menuText2, "sine", "square", "saw", command=lambda wavetype2: sound.menuTwoHit(wavetype2))
